...
hlv gates set-cwd <ID> "dir" # set existing working directory relative to project root
...
hlv constraints add-rule ... --check-command "cmd" --check-cwd "dir"  # validates command syntax and cwd before save
